...
## Section 12.3.3
### Question 2
The following code failed because instead of passing gather() the names of the columns that represent values as a string, it passed them as values. 
```{r}
table4a %>% 
...
### Question 3
Spreading the provided tibble fails because there are two entries for Pillip Wood's age. 

#You could add a new column to fix the problem BY::::
